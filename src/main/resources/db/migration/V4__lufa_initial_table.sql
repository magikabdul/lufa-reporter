...
CREATE TABLE IF NOT EXISTS lufa (
...
CREATE INDEX IF NOT EXISTS idx_lufa_created_at ON lufa (created_at);
CREATE INDEX IF NOT EXISTS idx_lufa_category ON lufa (category);
